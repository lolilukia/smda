(function() {
  var $, Calendar, DAYS, DateRangePicker, MONTHS, TEMPLATE, currentdate;
  ...
  DateRangePicker = (function() {
    ...
    DateRangePicker.prototype.setRange = function(daysAgo) {
      ...
      daysAgo -= 1;
      endDate = new Date(new Date(new Date().toLocaleDateString()).getTime() + 518400000);
      startDate = new Date(new Date(new Date().toLocaleDateString()).getTime() + 518400000);
  ...
  Calendar = (function() {
    ...
    Calendar.prototype.dayClass = function(day, firstDayOfMonth, lastDayOfMonth) {
      ...
      if (this.dateIsSelected(date)) {
        if(this.isStartCalendar || date >= this.dateRangePicker.startDate()){
        ...
        if (date < currentdate || (date.getTime() - currentdate.getTime()) >= 518400000) {
          classes += ' drp-day-disabled';
        }
      } else if (date.getTime() - currentdate.getTime() >= 518400000 || date < this.dateRangePicker.startDate()) { 
          classes += ' drp-day-disabled';
      }
